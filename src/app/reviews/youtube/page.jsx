    ...
    <div className="w-full md:1/2 ">
      ...
      <div className="w-[417px] bg-white m-3 p-5 rounded-[25px] shadow-red-400 shadow-lg ">
        ...
        <form action="" className="my-5 space-y-4">
          ...
          <div>
            <Inputi text="Youtube Video Title" placeholder="Enter Video Title"/>
          </div>

          <div>
            <TextArea text="Your Suggestion to improve the content" placeholder="Your Suggestion is Valube to us"/>
          </div>
                                                  {/* Submit button */}
          <div className="px-7">
            <button
