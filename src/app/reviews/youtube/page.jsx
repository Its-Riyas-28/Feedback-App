  ...
  return (
    ...
    <div className='bg-white ml-7 mt-7 w-[340px] rounded-2xl py-9 pl-2 pt-4 shadow-red-400 shadow-lg '>
        ...
        <form action='' className='my-5'>
          <div>
          <label htmlFor='improve' className='block text-gray-500 pl-4 '>How we can improve</label>
          <textarea placeholder='Enter Your feedback' className='bg-red-100 w-[300px] px-4 pt-2 mt-1 rounded ml-[10px]'></textarea>
          </div>


          <div>
            <button type='button' className='bg-red-500 font-semibold font-sans'>Submit</button>
          </div>
        </form>
    </div>
    </div>
